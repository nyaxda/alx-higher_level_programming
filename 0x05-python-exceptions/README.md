...
8. 100-safe_print_integer_err.py - function that prints an integer.
9. 101-safe_function.py - function that executes a function safely.
10. 102-magic_calculation.py - function  `def magic_calculation(a, b):`  that does exactly the same as the following Python bytecode:
