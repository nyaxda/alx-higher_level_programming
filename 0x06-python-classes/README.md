...
2. 1-square.py - a class  `Square`  that defines a square by: (based on  `0-square.py`)

-   Private instance attribute:  `size`
-   Instantiation with  `size`  (no type/value verification)
3. 2-square.py - a class  `Square`  that defines a square by: (based on  `1-square.py`)
...
-   Public instance method:  `def my_print(self):`  that prints in stdout the square with the character  `#`:
 ...
 7. 100-singly_linked_list.py - a class  `Node`  that defines a node of a singly linked list by:
...
-   Public instance method:  `def sorted_insert(self, value):`  that inserts a new  `Node`  into the correct sorted position in the list (increasing order)
 8. 101-square.py - a class  `Square`  that defines a square by: (based on  `6-square.py`)
...
-   Printing a  `Square`  instance should have the same behavior as  `my_print()`
 9. 102-square.py - a class  `Square`  that defines a square by: (based on  `4-square.py`)
...
-   `Square`  instance can answer to comparators:  `==`,  `!=`,  `>`,  `>=`,  `<`  and  `<=`  based on the square area
 10. 103-magic_class.py - a Python class  `MagicClass`  that does exactly the same as the following Python bytecode:
